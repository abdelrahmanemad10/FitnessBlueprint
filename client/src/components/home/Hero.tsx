    ...
    <div className="relative z-10 flex items-center justify-center h-full container mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center max-w-3xl">
        <h1 className="font-display text-5xl md:text-7xl mb-4 leading-tight">
          <span className="text-primary">AI</span> TRAINER <br />
          <span className="text-primary">FITNESS</span> REVOLUTION
        </h1>
        <p className="text-lg md:text-xl mb-8 text-muted-foreground">
          Where AI meets fitness excellence. Get access to smart, personalized training plans - completely free.
        </p>
